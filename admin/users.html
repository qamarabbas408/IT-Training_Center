            ...
            <div class="row">
                <div class="col-md-10">
                    <h1><i class="fas fa-cog"></i>
                        Users <small>Manage your Site Users</small>
                    </h1>
                </div>
                <div class="col-md-2">
                    <!-- dropdown -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tr>
                                    <td>Blog Post</td>
                                    <td>qmarabbas@gmail.com</td>
                                    <td>Dec 12,2019</td>
                                    <td><a href="edit.html" class="btn btn-default">Edit</a> <a href="delete.html"
                                            class="btn main-color-bg">Delete</a></td>
                                </tr>
                                <tr>
                                    <td>Blog Post</td>
                                    <td>qmarabbas@gmail.com</td>
                                    <td>Dec 12,2019</td>
                                    <td><a href="edit.html" class="btn btn-default">Edit</a> <a href="delete.html" class="btn main-color-bg">Delete</a>
                                    </td>
                                </tr><tr>
                                    <td>Blog Post</td>
                                    <td>qmarabbas@gmail.com</td>
