            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a href="#" class="list-group-item"><i class="fas fa-pencil-alt"></i> &nbsp;Posts <span
                ...
                <div class="col-md-9">
                    ...
                    <form action="">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="editor1" id="" cols="30" rows="10" placeholder="Page Body" class="form-control"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="">
                        ...
                        <div class="modal-footer">
                            <input type="submit" class="btn main-color-bg">Save changes</button>
                        </div>
                    </form>
